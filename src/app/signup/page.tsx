    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50/40 to-purple-50/40 p-6">
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
        ...
        <div className="hidden md:flex flex-col items-start justify-center p-8 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-lg h-full">
          <div className="mb-6">
            <h1 className="text-3xl font-extrabold">Join StudyQuest</h1>
            <p className="mt-2 text-sm opacity-90">Create an account to start mentoring or finding mentors.</p>
          </div>
          <div className="mt-6 bg-white/10 p-4 rounded-lg">
            <p className="text-sm">Fast signup, no fuss.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-8 h-full flex flex-col justify-center">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">A few details to get started</p>
              </div>
            </div>
            <div>
              <Link href="/signin" className="text-sm text-indigo-600 font-medium">Sign in</Link>
            </div>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>Already have an account? <Link href="/signin" className="text-indigo-600 font-medium">Sign in</Link></p>
          </div>
        </div>
      </div>
    </div>
